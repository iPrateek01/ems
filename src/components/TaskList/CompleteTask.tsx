...
function CompleteTask({data}) {
  return (
    ...
    {data.tasks.filter((task) => task.completed ).map((index) => (
          <div key={index.task_title} className='flex-shrink-0 flex flex-col justify-start items-center w-11/12 sm:w-9/12 md:w-4/12 h-80 p-5 rounded-md bg-blue-600 gap-7 text-center'>
